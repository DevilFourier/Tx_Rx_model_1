...
sig.T_over_sam = sig.T_sam/(sig.n_sy_over_sam+1);
%sampling frequency
sig.F_sam = 1/sig.T_sam; 
%sampling frequency
sig.F_over_sam = 1/sig.T_over_sam; 
%total number of samples (over sampled) 
sig.n_over_sam = sig.n_sy*sig.n_sy_sam + sig.n_sy*sig.n_sy_sam*sig.n_sy_over_sam - sig.n_sy_over_sam;
%estimated delay (s)
sig.delay = 1e-3;
